...
- [x] Define `Command` enum (no heap allocation)
...
- [x] Drain commands at the top of each audio callback
...
- [x] Implement atomic graph swap (by-value swap; old graph returned via Event)
